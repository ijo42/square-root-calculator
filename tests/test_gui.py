...
class TestHistoryDisplayManager:
    ...
    def test_update_display_truncates_long_results(self, history_display, mock_list_widget):
    ...
    def test_update_display_no_truncation_short_results(self, history_display, mock_list_widget):
