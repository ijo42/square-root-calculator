...
class Translator:
    ...
    TRANSLATIONS: Dict[str, Dict[str, str]] = {
        'en': {
            ...
            'precision_label': 'Precision (decimal places):',
        ...
        'ru': {
            ...
            'precision_label': 'Точность (знаков после запятой):',
